...
let modelInputSize = {width: window.innerWidth, height: window.innerHeight};
...
function loadGltfModel(){
    ...
    document.getElementById('loading-text').textContent = "Loading GLTF model new.....";
    const loader = new GLTFLoader();
    loader.load(
        // resource URL
        "resource/jacket2.glb",
        ...
        function ( gltf ){
            ...
            document.getElementById('loading-text').textContent = "GLTF loaded...";
